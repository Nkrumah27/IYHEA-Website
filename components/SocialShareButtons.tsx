...
const SocialShareButtons: React.FC<SocialShareButtonsProps> = ({ title }) => {
  const url = window.location.href; // Simplified for this single-page app context
    ...
    <div className="flex items-center space-x-1">
      ...
      {socialLinks.map(link => (
        <a 
          ...
          className="text-gray-500 hover:text-teal-600 transition-colors duration-300 p-2 rounded-full hover:bg-gray-100"
        >
          {link.icon}
        </a>
      ))}
